"""
Django settings for api_agenda project.
...
SECRET_KEY = 'django-insecure-krpgjaiygzhg_*t3vzm3f&sf!5x5w9es#+=nz3$!+*$2y)(+=1'
...
WSGI_APPLICATION = 'api_agenda.wsgi.application'
